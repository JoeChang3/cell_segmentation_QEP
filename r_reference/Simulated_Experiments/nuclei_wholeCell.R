...
library(latex2exp)
library(grid)
source('/Users/zchan/Desktop/projects/Cell_Seg_GP/code/cell_segmentation-main/src/2dim_lattice_func.R')
source("/Users/zchan/Desktop/projects/Cell_Seg_GP/code/cell_segmentation-main/src/DMD_alg_Apr20.R")

# load images
nuclei_figure <- readPNG("/Users/zchan/Desktop/projects/Cell_Seg_GP/code/cell_segmentation-main/Image_Data/simulation_cells/nuclei_2.png")
nuclei_figure <- nuclei_figure[,,1]
whole_cell_figure <- readJPEG("/Users/zchan/Desktop/projects/Cell_Seg_GP/code/cell_segmentation-main/Image_Data/simulation_cells/whole_cell_2.jpg")
